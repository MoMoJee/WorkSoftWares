...
First = 1
OutBreak = threading.Event()  # 使用 Event 来控制循环的退出
...
# 创建并启动生产者线程
producer_thread = threading.Thread(target=listen_for_messages)
